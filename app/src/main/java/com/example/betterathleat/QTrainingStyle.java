...
public class QTrainingStyle extends AppCompatActivity {
    private Button Next;
    private Button Main_Menu;
    private Button Back;
    private Button SubmitStyle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_q_training_style);


        radioGroup= (RadioGroup) findViewById(R.id.radioGroup);
        SubmitStyle=(Button) findViewById(R.id.Style_button);
        Next= (Button) findViewById(R.id.Next1);
        Next.setEnabled(false);
        SubmitStyle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                switch (radioId){
                    case R.id.FullBody:
                        ...
                        break;
                    case R.id.BroSplit:
                        TrainingStyle="BroSplit";
                        break;
                    case R.id.PushPull:
                        TrainingStyle="PushPull";
                        break;
                    case R.id.UpperLower:
                        TrainingStyle="UpperLower";
                        break;


                }
                updateData(TrainingStyle,MainActivity.TRAININGSTYLE);
    ...
    public void openNextActivity(){
        Intent intentopenNextActivity= new Intent(this, QPastProgramNum.class);
    ...
    public void openPrevActivity(){
        Intent intentopenPrevActivity= new Intent(this, QRepRange.class);
    ...
    private void UpdateUserIfPossible(){
        if(!get_shared_info_Gson_User( MainActivity.PASSUSER).GetName().equals("0")){
            ...
            user.SetTrainingStyle(get_shared_info_string(MainActivity.TRAININGSTYLE));
